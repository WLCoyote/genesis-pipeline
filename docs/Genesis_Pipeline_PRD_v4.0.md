...
| Campaigns | Marketing Campaigns — Email & SMS (C1-C8) | **In progress** — C1-C6 complete (schema, unsubscribe, email builder, audience/wizard, execution engine, dashboard/analytics), next: C7 SMS campaigns |
