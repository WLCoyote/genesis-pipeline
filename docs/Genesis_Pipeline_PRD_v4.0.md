...
| Phase 6 | Pricebook & pricing tools | 6.1–6.4 complete (pricebook CRUD, HCP import/sync, markup tiers, labor calc, bulk actions, cascading nav). Quote builder (6.5+) not started. |
