...
| Phase 6 | Pricebook & pricing tools | 6.1–6.5 complete. 6.6A–6.6D complete (schema, templates, quote builder, financing plans). 6.7 complete (HCP sync on quote creation). 6.8 (tax lookup) not started. |
