...
| Phase 6 | Pricebook & pricing tools | 6.1–6.5 complete. 6.6A complete (schema). 6.6B complete (quote templates CRUD). 6.6D complete (financing plans CRUD). Quote builder (6.6C), HCP sync (6.7), tax (6.8) not started. |
